                    ...
                    <form action="update.html" class="contact-form">
                        <div class="row">
						  ...
						  try {
							  ...
							  Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/motorbike","root","1234");
							  Statement stmt=con.createStatement();
							  ResultSet rs=stmt.executeQuery("select * from bikerent");
							  while(rs.next()){
								  ...
								  out.println("</div>");
								  out.println("<div class='col-lg-6'>");
								  out.println("<a href='logs?id= "+rs.getString(1)+"'> View Profile </a>");
								  out.println("</div>");
                         ...
                         %>
                            ...
                            <div class="col-lg-12 text-right">
                                <button type="submit" formaction="update">Oldest</button>
                            </div>
                        </div>
                    </form>
                </div>
