                    ...
                    <form action="" class="contact-form">
						...
						<% 
						  ...
						  try {
							  ...
							  Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/motorbike","root","1234");
							  Statement stmt=con.createStatement();
							  ResultSet rs=stmt.executeQuery("select * from user ORDER BY id DESC LIMIT 10");
							  while(rs.next()){
								  
								  out.println("<div class='col-lg-6'>");
								  out.println("<input type='text' value=" + rs.getString(2)+" readonly>");
								  out.println("</div>");
								  out.println("<div class='col-lg-6'>");
								  out.println("<a href='profiles?id= "+rs.getString(1)+"'> View Profile </a>");
								  out.println("</div>");
                         ...
                         %>
                            ...
                            <div class="col-lg-12 text-right">
                                <button type="submit" formaction="update">Oldest Members</button>
                            </div>
                        </div>
                    </form>
                </div>
